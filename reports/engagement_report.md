...
Generated: `2026-06-08T08:45:07.674989Z`

## Summary

- Measured posts: **18** of 18 published
- Median peak engagement: **0.0**
- Average peak engagement: **0.7**
- Top: **3** — harry0703/MoneyPrinterTurbo — 利用AI大模型，一键生成高清短视频 Generate short videos with one click using AI LLM.

## Patterns

- Release-keyword posts: avg **0.8** (n=10) vs others avg **0.6** (n=8)
- GitHub sources: avg **0.8** (n=17) vs other sources avg **0.0** (n=1)

## Ranked posts

1. **3 pts** — harry0703/MoneyPrinterTurbo — 利用AI大模型，一键生成高清短视频 Generate short videos with one click using AI LLM.
   likes 1 · reposts 0 · replies 0 · quotes 1 · age 228h · score 105
...
2. **2 pts** — chopratejas/headroom — Compress tool outputs, logs, files, and RAG chunks before they reach the LLM. 60-95% fewer tokens, same answers. Library, proxy, MCP server.
   likes 2 · reposts 0 · replies 0 · quotes 0 · age 108h · score 95
...
3. **2 pts** — NousResearch/hermes-agent — The agent that grows with you
   likes 1 · reposts 0 · replies 1 · quotes 0 · age 85h · score 90
...
4. **2 pts** — LangChain v1.1.0
   likes 0 · reposts 1 · replies 0 · quotes 0 · age 37h · score 60
...
5. **1 pts** — Lum1104/Understand-Anything — Graphs that teach > graphs that impress. Turn any code into an interactive knowledge graph you can explore, search, and ask questions about. Works with Claude Code, Codex
   likes 1 · reposts 0 · replies 0 · quotes 0 · age 239h · score 105
...
6. **1 pts** — Ollama v0.30.0
   likes 1 · reposts 0 · replies 0 · quotes 0 · age 216h · score 75
...
7. **1 pts** — Anthropic Python SDK v0.103.0
   likes 1 · reposts 0 · replies 0 · quotes 0 · age 192h · score 65
...
8. **1 pts** — Show HN: Lowfat – pluggable CLI filter that saved 91.8% of my LLM tokens
   likes 1 · reposts 0 · replies 0 · quotes 0 · age 43h · score 90
...
9. **0 pts** — Claude Opus 4.8
   likes 0 · reposts 0 · replies 0 · quotes 0 · age 233h · score 95
...
10. **0 pts** — Anthropic Python SDK v0.105.0
   likes 0 · reposts 0 · replies 0 · quotes 0 · age 165h · score 65
...
12. **0 pts** — can1357/oh-my-pi — ⌥ AI Coding agent for the terminal — hash-anchored edits, optimized tool harness, LSP, Python, browser, subagents, and more
...
14. **0 pts** — LangChain v1.3.4
   likes 0 · reposts 0 · replies 0 · quotes 0 · age 132h · score 75
...
16. **0 pts** — Open Code Review – An AI-powered code review CLI tool
...
17. **0 pts** — Anthropic Python SDK v0.106.0
...
18. **0 pts** — Claude Code v2.1.166
   likes 0 · reposts 0 · replies 0 · quotes 0 · age 24h · score 65
