...
35. **0 pts** — Anthropic Python SDK v0.105.0
...
37. **0 pts** — can1357/oh-my-pi — ⌥ AI Coding agent for the terminal — hash-anchored edits, optimized tool harness, LSP, Python, browser, subagents, and more
...
41. **0 pts** — Open Code Review – An AI-powered code review CLI tool
...
42. **0 pts** — Anthropic Python SDK v0.106.0
...
44. **0 pts** — Anthropic Python SDK v0.107.0
...
47. **0 pts** — Anthropic Python SDK v0.109.0
   likes 0 · reposts 0 · replies 0 · quotes 0 · age 352h · score 65
...
52. **0 pts** — Show HN: Vet turned founder, AI lawn diagnosis
...
53. **0 pts** — Anthropic Python SDK v0.109.2
...
54. **0 pts** — alibaba/zvec — A lightweight, lightning-fast, in-process vector database
...
56. **0 pts** — GLM-5.2 is the new leading open weights model on Artificial Analysis
...
59. **0 pts** — Kilo-Org/kilocode — Kilo is the all-in-one agentic engineering platform. Build, ship, and iterate faster with the most popular open source coding agent.
   likes 0 · reposts 0 · replies 0 · quotes 0 · age 350h · score 90
...
60. **0 pts** — Migrate from OpenClaw
...
61. **0 pts** — Anthropic Python SDK v0.111.0
