...
Generated: `2026-06-07T07:46:59.737137Z`

## Summary

- Measured posts: **17** of 17 published
...
- Release-keyword posts: avg **0.6** (n=10) vs others avg **0.7** (n=7)
- GitHub sources: avg **0.7** (n=16) vs other sources avg **0.0** (n=1)

## Ranked posts

1. **3 pts** — harry0703/MoneyPrinterTurbo — 利用AI大模型，一键生成高清短视频 Generate short videos with one click using AI LLM.
   likes 1 · reposts 0 · replies 0 · quotes 1 · age 203h · score 105
...
2. **2 pts** — chopratejas/headroom — Compress tool outputs, logs, files, and RAG chunks before they reach the LLM. 60-95% fewer tokens, same answers. Library, proxy, MCP server.
   likes 2 · reposts 0 · replies 0 · quotes 0 · age 83h · score 95
...
3. **2 pts** — NousResearch/hermes-agent — The agent that grows with you
   likes 1 · reposts 0 · replies 1 · quotes 0 · age 60h · score 90
...
4. **1 pts** — Lum1104/Understand-Anything — Graphs that teach > graphs that impress. Turn any code into an interactive knowledge graph you can explore, search, and ask questions about. Works with Claude Code, Codex
   likes 1 · reposts 0 · replies 0 · quotes 0 · age 214h · score 105
...
5. **1 pts** — Ollama v0.30.0
   likes 1 · reposts 0 · replies 0 · quotes 0 · age 191h · score 75
...
6. **1 pts** — Anthropic Python SDK v0.103.0
   likes 1 · reposts 0 · replies 0 · quotes 0 · age 167h · score 65
...
7. **1 pts** — Show HN: Lowfat – pluggable CLI filter that saved 91.8% of my LLM tokens
   likes 1 · reposts 0 · replies 0 · quotes 0 · age 18h · score 90
...
8. **0 pts** — Claude Opus 4.8
   likes 0 · reposts 0 · replies 0 · quotes 0 · age 208h · score 95
...
9. **0 pts** — Anthropic Python SDK v0.105.0
   likes 0 · reposts 0 · replies 0 · quotes 0 · age 140h · score 65
...
11. **0 pts** — can1357/oh-my-pi — ⌥ AI Coding agent for the terminal — hash-anchored edits, optimized tool harness, LSP, Python, browser, subagents, and more
...
13. **0 pts** — LangChain v1.3.4
   likes 0 · reposts 0 · replies 0 · quotes 0 · age 107h · score 75
...
15. **0 pts** — Open Code Review – An AI-powered code review CLI tool
   likes 0 · reposts 0 · replies 0 · quotes 0 · age 36h · score 60
...
16. **0 pts** — Anthropic Python SDK v0.106.0
...
17. **0 pts** — LangChain v1.1.0
   likes 0 · reposts 0 · replies 0 · quotes 0 · age 12h · score 60
