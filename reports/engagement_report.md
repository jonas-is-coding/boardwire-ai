...
Generated: `2026-08-10T05:16:13.475063Z`

## Summary

- Measured posts: **163** of 167 published
...
- Release-keyword posts: avg **0.6** (n=99) vs others avg **0.6** (n=64)
- GitHub sources: avg **0.7** (n=125) vs other sources avg **0.3** (n=38)
...
6. **3 pts** — harry0703/MoneyPrinterTurbo — 利用AI大模型，一键生成高清短视频 Generate short videos with one click using AI LLM.
...
8. **3 pts** — jamiepine/voicebox — The open-source AI voice studio. Clone, dictate, create.
...
9. **3 pts** — ZhuLinsen/daily_stock_analysis — LLM 驱动的多市场股票智能分析系统：多源行情、实时新闻、决策看板与自动推送，支持零成本定时运行。 LLM-powered multi-market stock analysis system with multi-source market data, real-time news, decision dashboard, aut
...
10. **3 pts** — TencentCloud/TencentDB-Agent-Memory — TencentDB Agent Memory delivers fully local long-term memory for AI Agents via a 4-tier progressive pipeline, with zero external API dependencies.
...
11. **3 pts** — Show HN: I RL-trained an agent that trains models with RL (for –$1.3k)
...
12. **3 pts** — Benchmarking Opus 5 on SlopCodeBench
   likes 1 · reposts 1 · replies 0 · quotes 0 · age 298h · score 85
...
13. **3 pts** — LangChain v1.4.2
   likes 1 · reposts 0 · replies 2 · quotes 0 · age 59h · score 90
...
14. **2 pts** — chopratejas/headroom — Compress tool outputs, logs, files, and RAG chunks before they reach the LLM. 60-95% fewer tokens, same answers. Library, proxy, MCP server.
...
15. **2 pts** — NousResearch/hermes-agent — The agent that grows with you
...
16. **2 pts** — Show HN: Lowfat – pluggable CLI filter that saved 91.8% of my LLM tokens
...
18. **2 pts** — mattpocock/skills — Skills for Real Engineers. Straight from my .claude directory.
...
19. **2 pts** — Anthropic Python SDK v0.110.0
...
20. **2 pts** — Identity verification on Claude
...
21. **2 pts** — browser-use/video-use — Edit videos with coding agents
...
22. **2 pts** — 0xNyk/council-of-high-intelligence — 18 AI personas deliberate your hardest decisions across multiple LLM providers. Aristotle, Feynman, Kahneman, Torvalds & more — structured multi-round deliberation
...
23. **2 pts** — Zackriya-Solutions/meetily — Privacy first, AI meeting assistant with 4x faster Parakeet/Whisper live transcription, speaker diarization, and Ollama summarization built on Rust. 100% local processing.
...
25. **2 pts** — Codex Security
   likes 2 · reposts 0 · replies 0 · quotes 0 · age 250h · score 90
...
26. **1 pts** — Lum1104/Understand-Anything — Graphs that teach > graphs that impress. Turn any code into an interactive knowledge graph you can explore, search, and ask questions about. Works with Claude Code, Codex
...
27. **1 pts** — Anthropic Python SDK v0.103.0
...
28. **1 pts** — luongnv89/claude-howto — A visual, example-driven guide to Claude Code — from basic concepts to advanced agents, with copy-paste templates that bring immediate value.
...
29. **1 pts** — Anthropic Python SDK v0.108.0
...
32. **1 pts** — palmier-io/palmier-pro — macOS video editor built for AI
...
33. **1 pts** — Show HN: Recall – fully-local project memory for Claude Code
...
34. **1 pts** — Good results fine tuning a local LLM like Qwen 3:0.6B to categorize questions
...
36. **1 pts** — anomalyco/opencode — The open source coding agent.
...
38. **1 pts** — Using Local Coding Agents
...
39. **1 pts** — Show HN: Adrafinil – keep a lid-closed Mac awake only while agents work
...
40. **1 pts** — Claude-real-video － any LLM can watch a video
...
42. **1 pts** — Show HN: Mcpsnoop – Wireshark for MCP (transparent proxy and live TUI)
...
43. **1 pts** — OthmanAdi/planning-with-files — Persistent file-based planning for AI coding agents and long-running agentic tasks. Crash-proof markdown plans that survive context loss and /clear, plus a deterministi
...
46. **1 pts** — AMD Ryzen AI Halo – $4k AI Dev Kit
...
47. **1 pts** — OfficeCLI: Office suite for AI agents to read and edit Microsoft Office files
...
48. **1 pts** — google-labs-code/stitch-skills — A library of Agent Skills designed to work with the Stitch MCP server. Each skill follows the Agent Skills open standard, for compatibility with coding agents such as 
...
50. **1 pts** — Differentiable Fortran with LFortran and Enzyme
...
51. **1 pts** — Bonsai 27B (1-bit LLM): The First 27B-Class Model to Run on a Phone
...
52. **1 pts** — Inkling – Open-Weights 975B Parameter LLM
...
54. **1 pts** — Show HN: OneCLI – OSS credential gateway that keeps secrets out of AI agents
   likes 1 · reposts 0 · replies 0 · quotes 0 · age 325h · score 90
...
56. **1 pts** — zhaoxuya520/reverse-skill — Reverse Engineering / Authorized Penetration Testing / Security Research Skill Router Pack AI-powered routing + On-demand toolchain bootstrapping + Self-evolving knowledge 
   likes 0 · reposts 0 · replies 1 · quotes 0 · age 230h · score 105
...
57. **1 pts** — antirez/ds4 — DeepSeek 4 Flash and PRO local inference engine for Metal, CUDA and ROCm
   likes 1 · reposts 0 · replies 0 · quotes 0 · age 157h · score 90
...
59. **0 pts** — Anthropic Python SDK v0.105.0
...
61. **0 pts** — can1357/oh-my-pi — ⌥ AI Coding agent for the terminal — hash-anchored edits, optimized tool harness, LSP, Python, browser, subagents, and more
...
65. **0 pts** — Open Code Review – An AI-powered code review CLI tool
...
66. **0 pts** — Anthropic Python SDK v0.106.0
...
68. **0 pts** — Anthropic Python SDK v0.107.0
...
71. **0 pts** — Anthropic Python SDK v0.109.0
   likes 0 · reposts 0 · replies 0 · quotes 0 · age 352h · score 65
...
76. **0 pts** — Show HN: Vet turned founder, AI lawn diagnosis
...
77. **0 pts** — Anthropic Python SDK v0.109.2
...
78. **0 pts** — alibaba/zvec — A lightweight, lightning-fast, in-process vector database
...
80. **0 pts** — GLM-5.2 is the new leading open weights model on Artificial Analysis
...
83. **0 pts** — Kilo-Org/kilocode — Kilo is the all-in-one agentic engineering platform. Build, ship, and iterate faster with the most popular open source coding agent.
   likes 0 · reposts 0 · replies 0 · quotes 0 · age 350h · score 90
...
84. **0 pts** — Migrate from OpenClaw
...
85. **0 pts** — Anthropic Python SDK v0.111.0
...
86. **0 pts** — Temporary Cloudflare Accounts for AI Agents
   likes 0 · reposts 0 · replies 0 · quotes 0 · age 347h · score 85
...
87. **0 pts** — garrytan/gstack — Use Garry Tan's exact Claude Code setup: 23 opinionated tools that serve as CEO, Designer, Eng Manager, Release Manager, Doc Engineer, and QA
   likes 0 · reposts 0 · replies 0 · quotes 0 · age 350h · score 90
...
90. **0 pts** — anthropics/claude-plugins-official — Official, Anthropic-managed directory of high quality Claude Code Plugins.
...
91. **0 pts** — Introducing computer use in Gemini 3.5 Flash
...
97. **0 pts** — alchaincyf/zhangxuefeng-skill — 张雪峰.skill — 张雪峰的认知操作系统。高考志愿/考研/职业规划的实战思维框架。由女娲.skill生成。
...
100. **0 pts** — DeepSeek open-sources inference optimizations with 60–85% faster generation [pdf]
...
101. **0 pts** — AMD Strix Halo RDMA Cluster Setup Guide
   likes 0 · reposts 0 · replies 0 · quotes 0 · age 352h · score 65
...
102. **0 pts** — Semgrep: GLM 5.2 beats Claude in our Cyber Benchmarks
...
103. **0 pts** — Show HN: NanoEuler – GPT-2 scale model in pure C/CUDA from scratch
...
104. **0 pts** — Herdr: Agent multiplexer that lives in your terminal
...
105. **0 pts** — Anthropic Python SDK v0.113.0
   likes 0 · reposts 0 · replies 0 · quotes 0 · age 344h · score 90
...
106. **0 pts** — Qwen 3.6 27B is the sweet spot for local development
   likes 0 · reposts 0 · replies 0 · quotes 0 · age 342h · score 90
...
107. **0 pts** — Micro-Agent: Beat Frontier Models with Collaboration Inside Model API
   likes 0 · reposts 0 · replies 0 · quotes 0 · age 337h · score 65
...
108. **0 pts** — diegosouzapw/OmniRoute — Never stop coding. Free AI gateway: one endpoint, 160+ providers (50+ free), connect Claude Code, Codex, Cursor, Cline & Copilot to FREE Claude/GPT/Gemini. RTK+Caveman stacked
...
109. **0 pts** — Start building with Nano Banana 2 Lite and Gemini Omni Flash
...
110. **0 pts** — Featuring Every Eval Ever Results on Hugging Face Model Pages
   likes 0 · reposts 0 · replies 0 · quotes 0 · age 345h · score 90
...
111. **0 pts** — Claude Code v2.1.197
...
112. **0 pts** — Anthropic Python SDK v0.115.0
...
113. **0 pts** — Claude Code v2.1.198
...
114. **0 pts** — Anthropic Python SDK v0.114.0
...
115. **0 pts** — The gauge broke: devs felt 20% faster with AI, measured 19% slower
...
116. **0 pts** — JuliusBrussee/caveman — 🪨 why use many token when few token do trick — Claude Code skill that cuts 65% of tokens by talking like caveman
...
117. **0 pts** — safishamsi/graphify — AI coding assistant skill (Claude Code, Codex, OpenCode, Cursor, Gemini CLI, and more). Turn any folder of code, SQL schemas, R scripts, shell scripts, docs, papers, images, or v
...
118. **0 pts** — The Safari MCP server for web developers
...
119. **0 pts** — Claude Code v2.1.200
...
120. **0 pts** — Claude Code v2.1.201
...
121. **0 pts** — Kagi Changelog (July 2): Heads, tails, and an AI toggle
...
123. **0 pts** — My AI-built PHP engine in Rust passes 17% of PHP-src tests, renders WordPress
...
124. **0 pts** — sqlite-utils 4.0rc2, mostly written by Claude Fable (for about $149.25)
...
125. **0 pts** — bradautomates/claude-video — Give Claude the ability to watch any video. /watch downloads, extracts frames, transcribes, hands it all to Claude.
...
127. **0 pts** — Claude Code v2.1.202
...
128. **0 pts** — Geosql: A Claude/Codex skill for geospatial data
...
129. **0 pts** — Mistral's Robostral Navigate: a state of the art robotics navigation model
...
132. **0 pts** — Claude Code v2.1.205
...
134. **0 pts** — Claude Code v2.1.206
...
137. **0 pts** — Better tools made Copilot code review worse. Here’s how we actually improved it.
...
139. **0 pts** — Claude Code v2.1.207
...
140. **0 pts** — A font that humans can read but AI cannot
...
141. **0 pts** — DayuanJiang/next-ai-draw-io — A next.js web application that integrates AI capabilities with draw.io diagrams. This app allows you to create, modify, and enhance diagrams through natural language comm
...
142. **0 pts** — Show HN: Reame – a CPU inference server that gets faster as it runs
...
143. **0 pts** — Show HN: Mindwalk – Replay coding-agent sessions on a 3D map of your codebase
...
144. **0 pts** — Fixed three bugs that made Qwen3.5-122B a daily driver on Mac Studio
...
145. **0 pts** — Claude Code sends 33k tokens before reading the prompt; OpenCode sends 7k
...
146. **0 pts** — Claude Code May–July 2026 weekly limits promotion
...
147. **0 pts** — Show HN: Clawk – Give coding agents a disposable Linux VM, not your laptop
...
149. **0 pts** — Claude Code v2.1.209
...
150. **0 pts** — Cursor 0day: When Full Disclosure Becomes the Only Protection Left
...
151. **0 pts** — Anthropic Python SDK v0.117.0
...
152. **0 pts** — Claude Code v2.1.214
   likes 0 · reposts 0 · replies 0 · quotes 0 · age 351h · score 65
...
153. **0 pts** — Introducing Cosmos 3 Edge
...
154. **0 pts** — Gemini 3.6 Flash, 3.5 Flash-Lite, and 3.5 Flash Cyber
...
156. **0 pts** — Anthropic Python SDK v0.118.0
   likes 0 · reposts 0 · replies 0 · quotes 0 · age 347h · score 90
...
157. **0 pts** — Anthropic Python SDK v0.119.0
...
158. **0 pts** — Anthropic Python SDK v0.120.2
...
159. **0 pts** — Anthropic Python SDK v0.120.1
   likes 0 · reposts 0 · replies 0 · quotes 0 · age 275h · score 65
...
160. **0 pts** — Claude Code v2.1.221
...
161. **0 pts** — cloudflare/computer — Give your agent a computer 👾
...
162. **0 pts** — Claude Code v2.1.224
   likes 0 · reposts 0 · replies 0 · quotes 0 · age 63h · score 90
...
163. **0 pts** — Anthropic Python SDK v0.121.0
   likes 0 · reposts 0 · replies 0 · quotes 0 · age 7h · score 90
