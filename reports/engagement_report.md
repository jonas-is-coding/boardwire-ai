...
Generated: `2026-09-23T08:55:23.912275Z`

## Account

- @boardwire.bsky.social: **31** followers (1d: +1, 7d: +5) · following 118 · posts 80 · snapshots 20 · as of `2026-09-23T08:55:09.700225Z`

## Summary

- Measured posts: **195** of 199 published
...
- Release-keyword posts: avg **0.6** (n=119) vs others avg **0.7** (n=76)
- GitHub sources: avg **0.7** (n=150) vs other sources avg **0.4** (n=45)

## Engagement by published hour (UTC)

- 00:00 UTC: avg **0.5** (n=13)
- 01:00 UTC: insufficient data (n<5, have 2)
- 04:00 UTC: avg **0.0** (n=6)
...
- #AI #LocalLLM: insufficient data (n<5, have 1)
...
- #LLM #LocalLLM #Ollama: insufficient data (n<5, have 2)
- #LocalLLM #Ollama #OpenSource: insufficient data (n<5, have 2)
...
- Others: avg **0.8** (n=104)
  (Version-only releases are now blocked by the quality gate; this group should trend to n=0.)

## Ranked posts

1. **5 pts** — Graphify-Labs/graphify — AI coding assistant skill (Claude Code, Codex, OpenCode, Cursor, Gemini CLI, and more). Turn any folder of code, SQL schemas, R scripts, shell scripts, docs, papers, images, o
   likes 2 · reposts 0 · replies 3 · quotes 0 · age 38h · score 90
   https://github.com/Graphify-Labs/graphify
   > Codebases become queryable graphs. Graphify turns folders into knowledge graphs for Claude Code, Codex, and Cursor, with +1028 stars. Graphi…

2. **4 pts** — Ollama v0.30.0
   likes 3 · reposts 0 · replies 1 · quotes 0 · age 360h · score 75
...
3. **4 pts** — Anthropic, please ship an official Claude Desktop for Linux
   likes 1 · reposts 1 · replies 1 · quotes 0 · age 347h · score 75
...
4. **4 pts** — GPT-5.5 hallucinates 3x more than MIT-licensed GLM-5.2
...
5. **4 pts** — Shubhamsaboo/awesome-llm-apps — 100+ AI Agent & RAG apps you can actually run — clone, customize, ship.
   likes 2 · reposts 1 · replies 0 · quotes 0 · age 66h · score 90
...
6. **4 pts** — Ollama v0.32.9
   likes 2 · reposts 1 · replies 0 · quotes 0 · age 346h · score 90
...
8. **3 pts** — harry0703/MoneyPrinterTurbo — 利用AI大模型，一键生成高清短视频 Generate short videos with one click using AI LLM.
...
9. **3 pts** — Claude Code v2.1.175
   likes 2 · reposts 0 · replies 1 · quotes 0 · age 354h · score 90
...
10. **3 pts** — jamiepine/voicebox — The open-source AI voice studio. Clone, dictate, create.
...
11. **3 pts** — ZhuLinsen/daily_stock_analysis — LLM 驱动的多市场股票智能分析系统：多源行情、实时新闻、决策看板与自动推送，支持零成本定时运行。 LLM-powered multi-market stock analysis system with multi-source market data, real-time news, decision dashboard, aut
   likes 1 · reposts 0 · replies 0 · quotes 1 · age 355h · score 90
...
12. **3 pts** — TencentCloud/TencentDB-Agent-Memory — TencentDB Agent Memory delivers fully local long-term memory for AI Agents via a 4-tier progressive pipeline, with zero external API dependencies.
   likes 1 · reposts 1 · replies 0 · quotes 0 · age 156h · score 90
   https://github.com/TencentCloud/TencentDB-Agent-Memory
   > Agent memory is now a local primitive with zero external APIs. TencentDB-Agent-Memory ships a 4-tier pipeline for persistent agent state, Ap…

13. **3 pts** — Show HN: I RL-trained an agent that trains models with RL (for –$1.3k)
   likes 2 · reposts 0 · replies 1 · quotes 0 · age 12h · score 85
...
14. **3 pts** — Benchmarking Opus 5 on SlopCodeBench
...
15. **3 pts** — LangChain v1.4.2
   likes 1 · reposts 0 · replies 2 · quotes 0 · age 346h · score 90
...
30. **2 pts** — cloudflare/security-audit-skill — A coding-agent skill for multi-phase security audits with independently verified, machine-readable findings
   likes 1 · reposts 0 · replies 1 · quotes 0 · age 158h · score 95
...
31. **2 pts** — google/ax — Google's open agentic orchestration runtime
   likes 1 · reposts 0 · replies 1 · quotes 0 · age 15h · score 95
...
33. **1 pts** — Anthropic Python SDK v0.103.0
...
34. **1 pts** — luongnv89/claude-howto — A visual, example-driven guide to Claude Code — from basic concepts to advanced agents, with copy-paste templates that bring immediate value.
...
35. **1 pts** — Anthropic Python SDK v0.108.0
...
38. **1 pts** — palmier-io/palmier-pro — macOS video editor built for AI
...
39. **1 pts** — Show HN: Recall – fully-local project memory for Claude Code
...
40. **1 pts** — Good results fine tuning a local LLM like Qwen 3:0.6B to categorize questions
...
42. **1 pts** — anomalyco/opencode — The open source coding agent.
...
44. **1 pts** — Using Local Coding Agents
...
45. **1 pts** — Show HN: Adrafinil – keep a lid-closed Mac awake only while agents work
...
46. **1 pts** — Claude-real-video － any LLM can watch a video
...
48. **1 pts** — Show HN: Mcpsnoop – Wireshark for MCP (transparent proxy and live TUI)
...
49. **1 pts** — OthmanAdi/planning-with-files — Persistent file-based planning for AI coding agents and long-running agentic tasks. Crash-proof markdown plans that survive context loss and /clear, plus a deterministi
...
52. **1 pts** — AMD Ryzen AI Halo – $4k AI Dev Kit
...
53. **1 pts** — OfficeCLI: Office suite for AI agents to read and edit Microsoft Office files
...
54. **1 pts** — google-labs-code/stitch-skills — A library of Agent Skills designed to work with the Stitch MCP server. Each skill follows the Agent Skills open standard, for compatibility with coding agents such as 
...
56. **1 pts** — Differentiable Fortran with LFortran and Enzyme
...
57. **1 pts** — Bonsai 27B (1-bit LLM): The First 27B-Class Model to Run on a Phone
...
58. **1 pts** — Inkling – Open-Weights 975B Parameter LLM
...
60. **1 pts** — Show HN: OneCLI – OSS credential gateway that keeps secrets out of AI agents
...
61. **1 pts** — Kimi-K3 on HuggingFace
...
62. **1 pts** — zhaoxuya520/reverse-skill — Reverse Engineering / Authorized Penetration Testing / Security Research Skill Router Pack AI-powered routing + On-demand toolchain bootstrapping + Self-evolving knowledge 
...
63. **1 pts** — antirez/ds4 — DeepSeek 4 Flash and PRO local inference engine for Metal, CUDA and ROCm
   likes 1 · reposts 0 · replies 0 · quotes 0 · age 348h · score 90
...
64. **1 pts** — Meta Muse Glimmer – open weights 30B local coding model
   likes 0 · reposts 0 · replies 1 · quotes 0 · age 350h · score 95
...
66. **1 pts** — Daybreak models are now available on AWS
...
67. **1 pts** — Apple introduces M6 and M5 Ultra for a big leap in performance and AI compute
...
69. **1 pts** — THU-MAIC/OpenMAIC — Open Multi-Agent Interactive Classroom — Get an immersive, multi-agent learning experience in just one click
   likes 1 · reposts 0 · replies 0 · quotes 0 · age 352h · score 90
...
73. **0 pts** — Anthropic Python SDK v0.105.0
   likes 0 · reposts 0 · replies 0 · quotes 0 · age 358h · score 65
...
74. **0 pts** — Claude Code v2.1.154
   likes 0 · reposts 0 · replies 0 · quotes 0 · age 352h · score 60
...
75. **0 pts** — can1357/oh-my-pi — ⌥ AI Coding agent for the terminal — hash-anchored edits, optimized tool harness, LSP, Python, browser, subagents, and more
   likes 0 · reposts 0 · replies 0 · quotes 0 · age 348h · score 90
...
76. **0 pts** — Ollama v0.30.0
   likes 0 · reposts 0 · replies 0 · quotes 0 · age 353h · score 90
...
77. **0 pts** — LangChain v1.3.4
   likes 0 · reposts 0 · replies 0 · quotes 0 · age 348h · score 75
...
78. **0 pts** — Ollama v0.30.3
   likes 0 · reposts 0 · replies 0 · quotes 0 · age 352h · score 90
...
79. **0 pts** — Open Code Review – An AI-powered code review CLI tool
   likes 0 · reposts 0 · replies 0 · quotes 0 · age 348h · score 60
...
80. **0 pts** — Anthropic Python SDK v0.106.0
   likes 0 · reposts 0 · replies 0 · quotes 0 · age 360h · score 85
...
81. **0 pts** — Claude Code v2.1.166
   likes 0 · reposts 0 · replies 0 · quotes 0 · age 335h · score 65
...
82. **0 pts** — Anthropic Python SDK v0.107.0
   likes 0 · reposts 0 · replies 0 · quotes 0 · age 352h · score 65
...
83. **0 pts** — Claude Fable 5
   likes 0 · reposts 0 · replies 0 · quotes 0 · age 347h · score 95
...
85. **0 pts** — Anthropic Python SDK v0.109.0
   likes 0 · reposts 0 · replies 0 · quotes 0 · age 352h · score 65
...
86. **0 pts** — LangChain v1.1.5
   likes 0 · reposts 0 · replies 0 · quotes 0 · age 348h · score 60
   https://github.com/langchain-ai/langchain/releases/tag/langchain-mistralai%3D%3D1.1.5
   > Local model serving becomes infrastructure. LangChain v1.1.5 enables local deployment, Apache 2.0 licensed. Reduces reliance on cloud servic…

87. **0 pts** — LangChain v1.3.9
   likes 0 · reposts 0 · replies 0 · quotes 0 · age 359h · score 85
   https://github.com/langchain-ai/langchain/releases/tag/langchain%3D%3D1.3.9
   > LangChain confines file-search results. Tightens Anthropic allowed_prefixes in LangChain v1.3.9, improving security and precision. LangChain…

88. **0 pts** — Claude Code v2.1.176
   likes 0 · reposts 0 · replies 0 · quotes 0 · age 355h · score 90
   https://github.com/anthropics/claude-code/releases/tag/v2.1.176
   > Credential caching becomes more reliable. Claude Code v2.1.176 adds regex link badges and improves credential caching with AWS cred expirati…

89. **0 pts** — Claude Code v2.1.178
   likes 0 · reposts 0 · replies 0 · quotes 0 · age 345h · score 90
   https://github.com/anthropics/claude-code/releases/tag/v2.1.178
   > Claude Code gains granular agent control. Claude Code v2.1.178 adds Tool(param:value) syntax for permission rules with 90 score. Anthropics …

90. **0 pts** — Show HN: Vet turned founder, AI lawn diagnosis
   likes 0 · reposts 0 · replies 0 · quotes 0 · age 337h · score 65
   https://grassdx.com/
   > Vertical AI SaaS is shipping in weeks, not years. GrassDX uses vision AI to diagnose lawn disease from a phone photo, Apache 2.0 on Hugging …

91. **0 pts** — Anthropic Python SDK v0.109.2
   likes 0 · reposts 0 · replies 0 · quotes 0 · age 356h · score 90
   https://github.com/anthropics/anthropic-sdk-python/releases/tag/v0.109.2
   > Anthropic removes retired models from API. Anthropic Python SDK v0.109.2 enforces updates to supported models, with 1 source and 0 engagemen…

92. **0 pts** — alibaba/zvec — A lightweight, lightning-fast, in-process vector database
   likes 0 · reposts 0 · replies 0 · quotes 0 · age 350h · score 90
   https://github.com/alibaba/zvec
   > In-process vector DB is shipping as an embeddings primitive. Alibaba’s zvec delivers sub-1ms vector search in-process, Apache 2.0, +251 star…

93. **0 pts** — Claude Code v2.1.179
   likes 0 · reposts 0 · replies 0 · quotes 0 · age 338h · score 70
   https://github.com/anthropics/claude-code/releases/tag/v2.1.179
   > Claude Code v2.1.179 stabilizes agentic workflows in Windows and WSL2. Fixes connection drops, stuck spinners, and WSL2 mouse-wheel scrollin…

94. **0 pts** — GLM-5.2 is the new leading open weights model on Artificial Analysis
   likes 0 · reposts 0 · replies 0 · quotes 0 · age 344h · score 90
   ...
   > Open-source LLMs get a new leader. GLM-5.2 tops Artificial Analysis benchmarks with open weights, 553 points on Hacker News. GLM-5.2 beats p…

95. **0 pts** — Simon Willison v4.1
   likes 0 · reposts 0 · replies 0 · quotes 0 · age 337h · score 95
   https://simonwillison.net/2026/Jun/17/glm-52/#atom-entries
   > Z.ai releases 753B MoE model. GLM-5.2 with 1M context window under MIT license, 1.51TB open weights on HuggingFace. MIT-licensed GLM-5.2 mod…

96. **0 pts** — Claude Code v2.1.181
   likes 0 · reposts 0 · replies 0 · quotes 0 · age 356h · score 90
   https://github.com/anthropics/claude-code/releases/tag/v2.1.181
   > Claude Code adds dynamic config control. v2.1.181 introduces /config key=value syntax and macOS automation via sandbox.allowAppleEvents, Apa…

97. **0 pts** — Kilo-Org/kilocode — Kilo is the all-in-one agentic engineering platform. Build, ship, and iterate faster with the most popular open source coding agent.
   likes 0 · reposts 0 · replies 0 · quotes 0 · age 350h · score 90
   https://github.com/Kilo-Org/kilocode
   > Agentic engineering platforms are gaining traction. Kilocode turns recall into persistent state for coding-agent workflows, with +1339 stars…

98. **0 pts** — Migrate from OpenClaw
   ...
   > Hermes Agent replaces OpenClaw. NousResearch migration guide has 58 comments and 85 points on HackerNews. NousResearch released a migration …

99. **0 pts** — Anthropic Python SDK v0.111.0
   likes 0 · reposts 0 · replies 0 · quotes 0 · age 344h · score 85
...
100. **0 pts** — Temporary Cloudflare Accounts for AI Agents
   likes 0 · reposts 0 · replies 0 · quotes 0 · age 347h · score 85
...
101. **0 pts** — garrytan/gstack — Use Garry Tan's exact Claude Code setup: 23 opinionated tools that serve as CEO, Designer, Eng Manager, Release Manager, Doc Engineer, and QA
   likes 0 · reposts 0 · replies 0 · quotes 0 · age 350h · score 90
...
104. **0 pts** — anthropics/claude-plugins-official — Official, Anthropic-managed directory of high quality Claude Code Plugins.
   likes 0 · reposts 0 · replies 0 · quotes 0 · age 342h · score 85
...
105. **0 pts** — Introducing computer use in Gemini 3.5 Flash
   likes 0 · reposts 0 · replies 0 · quotes 0 · age 347h · score 90
...
106. **0 pts** — Claude Code v2.1.191
   likes 0 · reposts 0 · replies 0 · quotes 0 · age 338h · score 90
...
109. **0 pts** — Claude Code v2.1.193
   likes 0 · reposts 0 · replies 0 · quotes 0 · age 353h · score 90
...
111. **0 pts** — alchaincyf/zhangxuefeng-skill — 张雪峰.skill — 张雪峰的认知操作系统。高考志愿/考研/职业规划的实战思维框架。由女娲.skill生成。
   likes 0 · reposts 0 · replies 0 · quotes 0 · age 345h · score 85
...
112. **0 pts** — Ollama v0.30.11
   likes 0 · reposts 0 · replies 0 · quotes 0 · age 342h · score 90
...
113. **0 pts** — Claude Code v2.1.195
   likes 0 · reposts 0 · replies 0 · quotes 0 · age 337h · score 90
...
114. **0 pts** — DeepSeek open-sources inference optimizations with 60–85% faster generation [pdf]
   likes 0 · reposts 0 · replies 0 · quotes 0 · age 355h · score 85
...
115. **0 pts** — AMD Strix Halo RDMA Cluster Setup Guide
   likes 0 · reposts 0 · replies 0 · quotes 0 · age 352h · score 65
...
116. **0 pts** — Semgrep: GLM 5.2 beats Claude in our Cyber Benchmarks
   likes 0 · reposts 0 · replies 0 · quotes 0 · age 343h · score 85
...
117. **0 pts** — Show HN: NanoEuler – GPT-2 scale model in pure C/CUDA from scratch
   likes 0 · reposts 0 · replies 0 · quotes 0 · age 354h · score 70
...
118. **0 pts** — Herdr: Agent multiplexer that lives in your terminal
   likes 0 · reposts 0 · replies 0 · quotes 0 · age 349h · score 85
...
119. **0 pts** — Anthropic Python SDK v0.113.0
   likes 0 · reposts 0 · replies 0 · quotes 0 · age 344h · score 90
...
120. **0 pts** — Qwen 3.6 27B is the sweet spot for local development
   likes 0 · reposts 0 · replies 0 · quotes 0 · age 342h · score 90
...
121. **0 pts** — Micro-Agent: Beat Frontier Models with Collaboration Inside Model API
   likes 0 · reposts 0 · replies 0 · quotes 0 · age 337h · score 65
...
122. **0 pts** — diegosouzapw/OmniRoute — Never stop coding. Free AI gateway: one endpoint, 160+ providers (50+ free), connect Claude Code, Codex, Cursor, Cline & Copilot to FREE Claude/GPT/Gemini. RTK+Caveman stacked
   likes 0 · reposts 0 · replies 0 · quotes 0 · age 353h · score 95
...
123. **0 pts** — Start building with Nano Banana 2 Lite and Gemini Omni Flash
   likes 0 · reposts 0 · replies 0 · quotes 0 · age 349h · score 90
...
124. **0 pts** — Featuring Every Eval Ever Results on Hugging Face Model Pages
   likes 0 · reposts 0 · replies 0 · quotes 0 · age 345h · score 90
...
125. **0 pts** — Claude Code v2.1.197
   likes 0 · reposts 0 · replies 0 · quotes 0 · age 344h · score 95
...
126. **0 pts** — Anthropic Python SDK v0.115.0
   likes 0 · reposts 0 · replies 0 · quotes 0 · age 342h · score 65
...
127. **0 pts** — Claude Code v2.1.198
   likes 0 · reposts 0 · replies 0 · quotes 0 · age 308h · score 60
...
128. **0 pts** — Anthropic Python SDK v0.114.0
   likes 0 · reposts 0 · replies 0 · quotes 0 · age 305h · score 65
...
129. **0 pts** — The gauge broke: devs felt 20% faster with AI, measured 19% slower
   likes 0 · reposts 0 · replies 0 · quotes 0 · age 301h · score 75
...
130. **0 pts** — JuliusBrussee/caveman — 🪨 why use many token when few token do trick — Claude Code skill that cuts 65% of tokens by talking like caveman
   likes 0 · reposts 0 · replies 0 · quotes 0 · age 289h · score 90
...
131. **0 pts** — safishamsi/graphify — AI coding assistant skill (Claude Code, Codex, OpenCode, Cursor, Gemini CLI, and more). Turn any folder of code, SQL schemas, R scripts, shell scripts, docs, papers, images, or v
   likes 0 · reposts 0 · replies 0 · quotes 0 · age 279h · score 105
...
132. **0 pts** — The Safari MCP server for web developers
   likes 0 · reposts 0 · replies 0 · quotes 0 · age 276h · score 90
...
133. **0 pts** — Claude Code v2.1.200
   likes 0 · reposts 0 · replies 0 · quotes 0 · age 272h · score 90
...
134. **0 pts** — Claude Code v2.1.201
   likes 0 · reposts 0 · replies 0 · quotes 0 · age 265h · score 90
...
135. **0 pts** — Kagi Changelog (July 2): Heads, tails, and an AI toggle
   likes 0 · reposts 0 · replies 0 · quotes 0 · age 258h · score 65
...
136. **0 pts** — Servers v2026.7.4
   likes 0 · reposts 0 · replies 0 · quotes 0 · age 241h · score 90
...
137. **0 pts** — My AI-built PHP engine in Rust passes 17% of PHP-src tests, renders WordPress
   likes 0 · reposts 0 · replies 0 · quotes 0 · age 236h · score 85
   https://ekinertac.com/blog/i-dont-know-rust-my-ai-is-rewriting-php-in-it/
   > AI-built PHP engine in Rust passes 17% of php-src tests. AIRP (AI-Rewritten PHP Runtime) renders WordPress with no Rust knowledge required. …

138. **0 pts** — sqlite-utils 4.0rc2, mostly written by Claude Fable (for about $149.25)
   likes 0 · reposts 0 · replies 0 · quotes 0 · age 234h · score 90
   https://simonwillison.net/2026/Jul/5/sqlite-utils-fable/
   > Claude Fable ships sqlite-utils 4.0rc2 for $149.25. sqlite-utils 4.0rc2 released on MIT License with AI-generated code replacing 333 lines. …

139. **0 pts** — bradautomates/claude-video — Give Claude the ability to watch any video. /watch downloads, extracts frames, transcribes, hands it all to Claude.
   likes 0 · reposts 0 · replies 0 · quotes 0 · age 203h · score 90
   https://github.com/bradautomates/claude-video
   > Claude-video turns raw video into multimodal input for Claude. bradautomates/claude-video automates downloads, frames, and transcriptions fo…

140. **0 pts** — Ollama v0.31.2-rc0
   likes 0 · reposts 0 · replies 0 · quotes 0 · age 200h · score 70
   https://github.com/ollama/ollama/releases/tag/v0.31.2-rc0
   > Ollama updates MLX for Apple Silicon. Ollama v0.31.2-rc0 ships with MLX de7b4ed9 update. Builders can test this release candidate for local …

141. **0 pts** — Claude Code v2.1.202
   likes 0 · reposts 0 · replies 0 · quotes 0 · age 163h · score 90
   https://github.com/anthropics/claude-code/releases/tag/v2.1.202
   > Claude Code adds observability primitives for agent workflows. Version 2.1.202 exposes `workflow.run_id` and `workflow.name` in OpenTelemetr…

142. **0 pts** — Geosql: A Claude/Codex skill for geospatial data
   likes 0 · reposts 0 · replies 0 · quotes 0 · age 159h · score 85
   https://github.com/dekart-xyz/geosql
   > Geosql enables LLMs for geospatial data. Geosql integrates Claude/Codex with location-based datasets via SQL, 85 score on HackerNews. Open-s…

143. **0 pts** — Mistral's Robostral Navigate: a state of the art robotics navigation model
   likes 0 · reposts 0 · replies 0 · quotes 0 · age 154h · score 90
   https://mistral.ai/news/robostral-navigate/
   > Mistral lowers barrier for autonomous systems. Robostral Navigate model available with immediate API access. Mistral's new robotics navigati…

144. **0 pts** — Ollama v0.31.2
   likes 0 · reposts 0 · replies 0 · quotes 0 · age 152h · score 85
   https://github.com/ollama/ollama/releases/tag/v0.31.2
   > Ollama updates local LLM development. Ollama v0.31.2 passes Ships Test with latest bug fixes and performance updates, Apache 2.0 licensed. D…

145. **0 pts** — Ollama v0.31.2
   likes 0 · reposts 0 · replies 0 · quotes 0 · age 150h · score 60
   https://github.com/ollama/ollama/releases/tag/v0.31.2-rc1
   > Local execution becomes default for model serving. Ollama v0.31.2 runs on-device with zero external calls, Apache 2.0. GitHub release. Self-…

146. **0 pts** — Claude Code v2.1.205
   likes 0 · reposts 0 · replies 0 · quotes 0 · age 145h · score 90
   https://github.com/anthropics/claude-code/releases/tag/v2.1.205
   > Claude Code v2.1.205 hardens session integrity for critical workflows. Auto mode blocks transcript tampering, fixes --json-schema output, an…

147. **0 pts** — LangChain v1.3.4
   likes 0 · reposts 0 · replies 0 · quotes 0 · age 134h · score 65
   https://github.com/langchain-ai/langchain/releases/tag/langchain-openai%3D%3D1.3.4
   > LangChain stabilizes OpenAI workflows. LangChain v1.3.4 fixes Pydantic serializer warnings for structured output, improving developer exper …

148. **0 pts** — Claude Code v2.1.206
   likes 0 · reposts 0 · replies 0 · quotes 0 · age 121h · score 90
   https://github.com/anthropics/claude-code/releases/tag/v2.1.206
   > Claude Code optimizes context with /doctor check. Trims CLAUDE.md files, auto-allows git push to configured remotes, with /cd path suggestio…

149. **0 pts** — Simon Willison v5.6
   likes 0 · reposts 0 · replies 0 · quotes 0 · age 118h · score 95
   https://simonwillison.net/2026/Jul/9/gpt-5-6/#atom-entries
   > OpenAI’s GPT-5.6 models hit GA with explicit agentic pricing. Luna, Terra, Sol debut at $1–5 per 1M input and $6–30 per 1M output tokens via…

150. **0 pts** — Servers v2026.7.10
   likes 0 · reposts 0 · replies 0 · quotes 0 · age 114h · score 90
   https://github.com/modelcontextprotocol/servers/releases/tag/2026.7.10
   > Core MCP server primitives update to v2026.7.10. MCP Servers v2026.7.10 refreshes filesystem, time, fetch, and git servers. MIT license. Ava…

151. **0 pts** — Better tools made Copilot code review worse. Here’s how we actually improved it.
   likes 0 · reposts 0 · replies 0 · quotes 0 · age 108h · score 70
   https://github.blog/ai-and-ml/github-copilot/better-tools-made-copilot-code-review-worse-heres-how-we-actually-improved-it/
   > GitHub cut Copilot code review costs with Unix-style agent workflows. GitHub Blog details a production methodology that reduced review cost …

152. **0 pts** — LangChain v1.3.5
   ...
   > LangChain adds prompt caching. LangChain v1.3.5 supports explicit prompt caching, reducing API costs and latency. Builders can use LangChain…

153. **0 pts** — Claude Code v2.1.207
   likes 0 · reposts 0 · replies 0 · quotes 0 · age 90h · score 90
   https://github.com/anthropics/claude-code/releases/tag/v2.1.207
   > Claude Code turns Auto mode into default infrastructure on Bedrock and v2.1.207 ships with Auto mode enabled by default on major platforms, …

154. **0 pts** — A font that humans can read but AI cannot
   likes 0 · reposts 0 · replies 0 · quotes 0 · age 88h · score 85
   https://www.mixfont.com/ghost-font
   > Ghost Font defends human text against AI extraction. Ghost Font releases first human-readable, AI-resistant font. Apache 2.0. Drop-in for we…

155. **0 pts** — DayuanJiang/next-ai-draw-io — A next.js web application that integrates AI capabilities with draw.io diagrams. This app allows you to create, modify, and enhance diagrams through natural language comm
   likes 0 · reposts 0 · replies 0 · quotes 0 · age 84h · score 85
   https://github.com/DayuanJiang/next-ai-draw-io
   > AI-driven diagram creation lands in Next.js. Next-ai-draw-io integrates natural language with draw.io, +74 stars today. Open-source Next.js …

156. **0 pts** — Show HN: Reame – a CPU inference server that gets faster as it runs
   likes 0 · reposts 0 · replies 0 · quotes 0 · age 71h · score 85
   https://github.com/swellweb/reame
   > CPU inference gets faster runtime. Reame, an open-source server, improves performance over time with 85 score on Hacker News. Reame ships to…

157. **0 pts** — Show HN: Mindwalk – Replay coding-agent sessions on a 3D map of your codebase
   likes 0 · reposts 0 · replies 0 · quotes 0 · age 67h · score 85
   https://github.com/cosmtrek/mindwalk
   > Coding agents get transparent sessions. Mindwalk visualizes agent navigation on a 3D codebase map, with 85 score on HackerNews. Open-source …

158. **0 pts** — Fixed three bugs that made Qwen3.5-122B a daily driver on Mac Studio
   ...
   > Qwen3.5-122B runs as daily driver on Mac Studio. Fixed three bugs enable local inference, 49 points on HackerNews. 122B model runs locally, …

159. **0 pts** — Claude Code sends 33k tokens before reading the prompt; OpenCode sends 7k
   likes 0 · reposts 0 · replies 0 · quotes 0 · age 56h · score 90
   https://systima.ai/blog/claude-code-vs-opencode-token-overhead
   > Claude Code API has 33k token overhead. Overhead is 26k tokens more than OpenCode, impacting builder costs and context window efficiency. Hi…

160. **0 pts** — Claude Code May–July 2026 weekly limits promotion
   likes 0 · reposts 0 · replies 0 · quotes 0 · age 54h · score 75
   https://support.claude.com/en/articles/15910845-claude-code-may-july-2026-weekly-limits-promotion
   > Claude Code boosts weekly limits. Anthropic offers higher weekly limits from May to July 2026, with 49 comments on Hacker News. Temporary pr…

161. **0 pts** — Show HN: Clawk – Give coding agents a disposable Linux VM, not your laptop
   likes 0 · reposts 0 · replies 0 · quotes 0 · age 35h · score 90
   https://github.com/clawkwork/clawk
   > Coding agents get disposable Linux VMs. Clawk provides isolated execution with 95 points and 102 comments on Hacker News, open-source under …

162. **0 pts** — Ollama v0.32.0
   likes 0 · reposts 0 · replies 0 · quotes 0 · age 30h · score 90
   https://github.com/ollama/ollama/releases/tag/v0.32.0
   > Ollama integrates Qwen3.5/Next models. Adds Qwen3.5 parser and renderer, with 1 source and 0 engagement. Ollama v0.32.0 supports local deplo…

163. **0 pts** — Claude Code v2.1.209
   likes 0 · reposts 0 · replies 0 · quotes 0 · age 14h · score 90
   https://github.com/anthropics/claude-code/releases/tag/v2.1.209
   > Claude Code fixes background-agent dialogs. v2.1.209 unblocks /model and stdin in claude agents background sessions. Reverts overly broad gu…

164. **0 pts** — Cursor 0day: When Full Disclosure Becomes the Only Protection Left
...
165. **0 pts** — Anthropic Python SDK v0.117.0
   likes 0 · reposts 0 · replies 0 · quotes 0 · age 351h · score 65
...
166. **0 pts** — Claude Code v2.1.214
   likes 0 · reposts 0 · replies 0 · quotes 0 · age 351h · score 65
...
167. **0 pts** — Introducing Cosmos 3 Edge
   likes 0 · reposts 0 · replies 0 · quotes 0 · age 358h · score 90
...
168. **0 pts** — Gemini 3.6 Flash, 3.5 Flash-Lite, and 3.5 Flash Cyber
   likes 0 · reposts 0 · replies 0 · quotes 0 · age 351h · score 90
...
169. **0 pts** — LangChain v1.3.0
   likes 0 · reposts 0 · replies 0 · quotes 0 · age 350h · score 60
...
170. **0 pts** — Anthropic Python SDK v0.118.0
   likes 0 · reposts 0 · replies 0 · quotes 0 · age 347h · score 90
...
171. **0 pts** — Anthropic Python SDK v0.119.0
...
172. **0 pts** — Anthropic Python SDK v0.120.2
   likes 0 · reposts 0 · replies 0 · quotes 0 · age 350h · score 65
...
173. **0 pts** — Anthropic Python SDK v0.120.1
   likes 0 · reposts 0 · replies 0 · quotes 0 · age 347h · score 65
...
174. **0 pts** — Claude Code v2.1.221
   likes 0 · reposts 0 · replies 0 · quotes 0 · age 348h · score 90
...
177. **0 pts** — Anthropic Python SDK v0.121.0
   likes 0 · reposts 0 · replies 0 · quotes 0 · age 342h · score 90
...
178. **0 pts** — Meta is back with Muse Glimmer: local, agentic, multimodal, and open source
   likes 0 · reposts 0 · replies 0 · quotes 0 · age 346h · score 90
...
179. **0 pts** — Expanding Daybreak as the Cyber Defense Window Narrows
   likes 0 · reposts 0 · replies 0 · quotes 0 · age 326h · score 90
...
180. **0 pts** — unslothai/unsloth — Local UI to run and train LLMs and diffusion models, including Qwen3.8, Kimi K3, MiniMax-H3, Gemma 4, DeepSeek-V4, FLUX and more.
   likes 0 · reposts 0 · replies 0 · quotes 0 · age 336h · score 90
   https://github.com/unslothai/unsloth
   > Local UI simplifies LLM training. Unsloth indexes Qwen3.8, Gemma 4, DeepSeek-V4, +592 stars. #LLM #AI

181. **0 pts** — Ollama v0.32.10-rc0
   likes 0 · reposts 0 · replies 0 · quotes 0 · age 357h · score 60
...
182. **0 pts** — Ollama v0.32.8
   likes 0 · reposts 0 · replies 0 · quotes 0 · age 356h · score 65
...
184. **0 pts** — Anthropic Python SDK v0.125.0
   likes 0 · reposts 0 · replies 0 · quotes 0 · age 354h · score 90
...
185. **0 pts** — Claude Code v2.1.238
   likes 0 · reposts 0 · replies 0 · quotes 0 · age 350h · score 90
...
186. **0 pts** — tinyhumansai/openhuman — Your Personal AI super intelligence. A brain that builds a local-first memory of your life, a fantastic orchestrator of agent fleets and workflows, and a deep researcher.
   likes 0 · reposts 0 · replies 0 · quotes 0 · age 354h · score 70
...
187. **0 pts** — Advancing price-performance for developers with GPT‑5.6 in Kiro
   likes 0 · reposts 0 · replies 0 · quotes 0 · age 354h · score 90
...
188. **0 pts** — tt-a1i/archify — Agent skill for beautiful, verifiable architecture, workflow, sequence, data-flow, and lifecycle diagrams—self-contained HTML with motion and crisp export.
   likes 0 · reposts 0 · replies 0 · quotes 0 · age 354h · score 90
...
189. **0 pts** — Anthropic Python SDK v1.2.0
   likes 0 · reposts 0 · replies 0 · quotes 0 · age 345h · score 90
...
190. **0 pts** — Claude Code v2.1.248
...
191. **0 pts** — AI Engineer Notebooks – free, framework-free RAG/agents/evals on Colab
...
193. **0 pts** — jingyaogong/minimind — 🧠 Train a 64M-parameter LLM from scratch in just 2h!
   likes 0 · reposts 0 · replies 0 · quotes 0 · age 347h · score 90
...
194. **0 pts** — pacifio/atlas — Source control for agents. Use multiple coding agents, track their changes and query them in one place
   likes 0 · reposts 0 · replies 0 · quotes 0 · age 352h · score 90
...
195. **0 pts** — Claude Code v2.1.266
   likes 0 · reposts 0 · replies 0 · quotes 0 · age 303h · score 85
