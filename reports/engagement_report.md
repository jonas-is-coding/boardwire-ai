...
Generated: `2026-06-30T07:42:18.286139Z`

## Summary

- Measured posts: **80** of 80 published
- Median peak engagement: **0.0**
- Average peak engagement: **0.7**
- Top: **4** — Ollama v0.30.0

## Patterns

- Release-keyword posts: avg **0.6** (n=50) vs others avg **0.8** (n=30)
- GitHub sources: avg **0.7** (n=64) vs other sources avg **0.5** (n=16)
...
3. **4 pts** — GPT-5.5 hallucinates 3x more than MIT-licensed GLM-5.2
   likes 2 · reposts 0 · replies 2 · quotes 0 · age 229h · score 90
...
6. **3 pts** — jamiepine/voicebox — The open-source AI voice studio. Clone, dictate, create.
   likes 2 · reposts 0 · replies 1 · quotes 0 · age 233h · score 90
...
7. **3 pts** — ZhuLinsen/daily_stock_analysis — LLM 驱动的多市场股票智能分析系统：多源行情、实时新闻、决策看板与自动推送，支持零成本定时运行。 LLM-powered multi-market stock analysis system with multi-source market data, real-time news, decision dashboard, aut
   likes 1 · reposts 0 · replies 0 · quotes 1 · age 211h · score 90
...
12. **2 pts** — mattpocock/skills — Skills for Real Engineers. Straight from my .claude directory.
   likes 2 · reposts 0 · replies 0 · quotes 0 · age 303h · score 95
...
13. **2 pts** — Anthropic Python SDK v0.110.0
   likes 1 · reposts 0 · replies 1 · quotes 0 · age 263h · score 95
...
14. **2 pts** — Identity verification on Claude
   likes 2 · reposts 0 · replies 0 · quotes 0 · age 203h · score 75
...
15. **1 pts** — Lum1104/Understand-Anything — Graphs that teach > graphs that impress. Turn any code into an interactive knowledge graph you can explore, search, and ask questions about. Works with Claude Code, Codex
...
16. **1 pts** — Anthropic Python SDK v0.103.0
...
17. **1 pts** — luongnv89/claude-howto — A visual, example-driven guide to Claude Code — from basic concepts to advanced agents, with copy-paste templates that bring immediate value.
...
18. **1 pts** — Anthropic Python SDK v0.108.0
...
19. **1 pts** — Ollama v0.30.9
   likes 1 · reposts 0 · replies 0 · quotes 0 · age 308h · score 90
...
21. **1 pts** — palmier-io/palmier-pro — macOS video editor built for AI
...
22. **1 pts** — Show HN: Recall – fully-local project memory for Claude Code
   likes 0 · reposts 0 · replies 1 · quotes 0 · age 193h · score 90
...
23. **1 pts** — Good results fine tuning a local LLM like Qwen 3:0.6B to categorize questions
   likes 0 · reposts 0 · replies 1 · quotes 0 · age 187h · score 85
...
24. **1 pts** — Claude Code v2.1.187
   likes 1 · reposts 0 · replies 0 · quotes 0 · age 129h · score 90
...
25. **1 pts** — anomalyco/opencode — The open source coding agent.
   likes 0 · reposts 0 · replies 1 · quotes 0 · age 67h · score 90
...
26. **1 pts** — vLLM v0.24.0
   likes 1 · reposts 0 · replies 0 · quotes 0 · age 65h · score 90
...
27. **1 pts** — Using Local Coding Agents
   likes 1 · reposts 0 · replies 0 · quotes 0 · age 60h · score 90
...
28. **1 pts** — Show HN: Adrafinil – keep a lid-closed Mac awake only while agents work
...
29. **1 pts** — browser-use/video-use — Edit videos with coding agents
...
30. **1 pts** — 0xNyk/council-of-high-intelligence — 18 AI personas deliberate your hardest decisions across multiple LLM providers. Aristotle, Feynman, Kahneman, Torvalds & more — structured multi-round deliberation
   likes 1 · reposts 0 · replies 0 · quotes 0 · age 13h · score 90
...
32. **0 pts** — Anthropic Python SDK v0.105.0
...
34. **0 pts** — can1357/oh-my-pi — ⌥ AI Coding agent for the terminal — hash-anchored edits, optimized tool harness, LSP, Python, browser, subagents, and more
...
38. **0 pts** — Open Code Review – An AI-powered code review CLI tool
...
39. **0 pts** — Anthropic Python SDK v0.106.0
...
41. **0 pts** — Anthropic Python SDK v0.107.0
...
44. **0 pts** — Anthropic Python SDK v0.109.0
   likes 0 · reposts 0 · replies 0 · quotes 0 · age 352h · score 65
...
49. **0 pts** — Show HN: Vet turned founder, AI lawn diagnosis
...
50. **0 pts** — Anthropic Python SDK v0.109.2
   likes 0 · reposts 0 · replies 0 · quotes 0 · age 331h · score 90
...
51. **0 pts** — alibaba/zvec — A lightweight, lightning-fast, in-process vector database
...
52. **0 pts** — Claude Code v2.1.179
   likes 0 · reposts 0 · replies 0 · quotes 0 · age 313h · score 70
...
53. **0 pts** — GLM-5.2 is the new leading open weights model on Artificial Analysis
...
54. **0 pts** — Simon Willison v4.1
   likes 0 · reposts 0 · replies 0 · quotes 0 · age 290h · score 95
...
55. **0 pts** — Claude Code v2.1.181
   likes 0 · reposts 0 · replies 0 · quotes 0 · age 285h · score 90
...
56. **0 pts** — Kilo-Org/kilocode — Kilo is the all-in-one agentic engineering platform. Build, ship, and iterate faster with the most popular open source coding agent.
   likes 0 · reposts 0 · replies 0 · quotes 0 · age 279h · score 90
...
57. **0 pts** — Migrate from OpenClaw
   likes 0 · reposts 0 · replies 0 · quotes 0 · age 276h · score 85
...
58. **0 pts** — Anthropic Python SDK v0.111.0
   likes 0 · reposts 0 · replies 0 · quotes 0 · age 273h · score 85
...
59. **0 pts** — Temporary Cloudflare Accounts for AI Agents
...
60. **0 pts** — garrytan/gstack — Use Garry Tan's exact Claude Code setup: 23 opinionated tools that serve as CEO, Designer, Eng Manager, Release Manager, Doc Engineer, and QA
...
63. **0 pts** — anthropics/claude-plugins-official — Official, Anthropic-managed directory of high quality Claude Code Plugins.
...
64. **0 pts** — Introducing computer use in Gemini 3.5 Flash
...
67. **0 pts** — Ollama v0.30.11
   likes 0 · reposts 0 · replies 0 · quotes 0 · age 93h · score 90
...
70. **0 pts** — alchaincyf/zhangxuefeng-skill — 张雪峰.skill — 张雪峰的认知操作系统。高考志愿/考研/职业规划的实战思维框架。由女娲.skill生成。
   likes 0 · reposts 0 · replies 0 · quotes 0 · age 83h · score 85
...
73. **0 pts** — DeepSeek open-sources inference optimizations with 60–85% faster generation [pdf]
...
74. **0 pts** — AMD Strix Halo RDMA Cluster Setup Guide
   likes 0 · reposts 0 · replies 0 · quotes 0 · age 41h · score 65
...
75. **0 pts** — Semgrep: GLM 5.2 beats Claude in our Cyber Benchmarks
   likes 0 · reposts 0 · replies 0 · quotes 0 · age 31h · score 85
...
76. **0 pts** — Show HN: NanoEuler – GPT-2 scale model in pure C/CUDA from scratch
   likes 0 · reposts 0 · replies 0 · quotes 0 · age 20h · score 70
...
77. **0 pts** — Herdr: Agent multiplexer that lives in your terminal
...
78. **0 pts** — Anthropic Python SDK v0.113.0
...
79. **0 pts** — Qwen 3.6 27B is the sweet spot for local development
   likes 0 · reposts 0 · replies 0 · quotes 0 · age 8h · score 90
...
80. **0 pts** — Micro-Agent: Beat Frontier Models with Collaboration Inside Model API
   likes 0 · reposts 0 · replies 0 · quotes 0 · age 3h · score 65
